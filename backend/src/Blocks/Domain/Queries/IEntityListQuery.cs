...
/// <summary>
/// Defines the direction in which to order the results of a query.
/// </summary>
...
public interface IEntityListQuery<TEntity> : IModelListQuery<TEntity>
	where TEntity : Entity
{
	...
	/// </remarks>
	Expression<Func<TEntity, bool>>? Filter { get; init; }
	...
	// /// </remarks>
	// bool FilteringEnabled { get; init; }

	/// <summary>
	/// Gets a value indicating whether to retrieve only active entities.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	bool OnlyActive { get; init; }

	/// <summary>
	/// Gets the order by expressions to apply to the query.
	/// </summary>
	IEnumerable<Tuple<Expression<Func<TEntity, object>>, OrderDirection>>? OrderBy { get; init; }

	/// <summary>
	/// Gets the pagination token to use for incremental synchronization.
	/// </summary>
	/// <remarks>
	/// This property allows you to specify a pagination token that will be used to retrieve the next set of entities in an incremental synchronization scenario. The token should be obtained from the previous query result and passed back to the query to retrieve the next set of entities.
	/// </remarks>
	string? PaginationToken { get; init; }

	/// <summary>
	/// Gets the search string to use for searching entities using full-text search or other search mechanisms.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	/// Gets the selector expression to project the entities into a different representation.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	Expression<Func<TEntity, dynamic>> Selector { get; init; }

	/// <summary>
	/// Gets the synchronization token to use for incremental synchronization.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	string? SynchronizationToken { get; init; }
}
