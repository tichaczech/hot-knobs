	...
	where TCreateRequest : class, IResourceCreateRequest
{
	...
	/// <returns></returns>
	ValueTask<TResponse> Create(TCreateRequest request, CancellationToken cancellationToken = default);
}
	...
	where TCreateOrUpdateRequest : class, IResourceCreateOrUpdateRequest
{
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	ValueTask<TResponse> CreateOrUpdate(TCreateOrUpdateRequest request, string? id = default, string? etag = default, CancellationToken cancellationToken = default);
}
	...
	where TResponse : class, IResourceResponse
{
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	ValueTask<TResponse> Get(string id, string? etag = default, bool onlyActive = true, CancellationToken cancellationToken = default);
}
	...
	where TResponse : class, IResourceResponse
{
	...
	/// <param name="synchronizationToken"></param>
	/// <param name="cancellationToken">A cancellation token.</param>
	/// <returns>A collection representing the ids of resources that match the specified criteria.</returns>
	IAsyncEnumerable<dynamic> List(string? columns = default, string? filter = default, bool onlyActive = true, string? orderBy = default, string? paginationToken = default, string? search = default, string? synchronizationToken = default, CancellationToken cancellationToken = default);
}
	...
	where TUpdateRequest : class, IResourceUpdateRequest
{
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	ValueTask<TResponse> Update(TUpdateRequest request, string id, string etag, CancellationToken cancellationToken = default);
}
