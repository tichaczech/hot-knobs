	...
	where TCreateOrUpdateRequest : class, ISingletonResourceCreateOrUpdateRequest
{
	...
	/// <returns></returns>
	ValueTask<TResponse> CreateOrUpdate(TCreateOrUpdateRequest request, CancellationToken cancellationToken = default);
}
	...
	where TResponse : class, ISingletonResourceResponse
{
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	ValueTask<TResponse> Get(CancellationToken cancellationToken = default);
}
