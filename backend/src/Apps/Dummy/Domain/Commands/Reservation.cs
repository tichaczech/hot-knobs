...
public record ReservationCreateCommand : EntityCreateCommand<ReservationModel, Reservation>;

public record ReservationDeleteCommand : EntityDeleteCommand;

public record ReservationUpdateCommand : EntityUpdateCommand<ReservationModel, Reservation>;
