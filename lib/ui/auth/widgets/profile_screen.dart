...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.white, title: const Text('Profile')),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          const CircleAvatar(backgroundImage: NetworkImage('https://i.postimg.cc/0jqKB6mS/Profile-Image.png')),
          Positioned(
            right: -16,
            bottom: 0,
            child: SizedBox(
      ...
      child: TextButton(
        ...
        child: Row(
          children: [
            ...
            // SvgPicture.asset(icon, colorFilter: const ColorFilter.mode(Color(0xFFFF7643), BlendMode.srcIn), width: 22),
