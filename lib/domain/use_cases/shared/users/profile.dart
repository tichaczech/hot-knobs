...
//   ProfileUseCases({required FirebaseMessaging firebaseMessaging, required UserProfileRepository userProfileRepository}) {
...
//   final _log = Logger('Shared:Users:ProfileUseCases');
