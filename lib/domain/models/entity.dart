...
abstract class Entity with EntityMappable, ModelTargetMapping {
  ...
  Entity({required this.id, required this.active, required this.cachedAt, required this.createdAt, required this.createdBy, required this.etag, required this.updatedAt, required this.updatedBy}) {
    print('Entity created: $id');
  }
}
