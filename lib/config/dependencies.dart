...
class Providers {
  static List<SingleChildWidget> get({LocalServiceType localServiceType = LocalServiceType.reaxdb, RemoteServiceType remoteServiceType = RemoteServiceType.firebase}) {
    ...
    return [...localProviders, ...remoteProviders, ..._sharedProviders];
  }
}
...
List<SingleChildWidget> _sharedProviders = [
  ...
  // Repositories
  Provider<OperatorRepository>(create: (context) => OperatorRepository(
    localService: context.read(),
    remoteService: context.read(),
  )),
  Provider<SiteRepository>(create: (context) => SiteRepository(
    localService: context.read(),
    remoteService: context.read(),
  )),
  Provider<UserProfileRepository>(create: (context) => UserProfileRepository(
    localService: context.read(),
    remoteService: context.read(),
  )),
];
